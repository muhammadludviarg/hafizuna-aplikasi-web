    ...
    <div class="p-6 text-gray-900 dark:text-gray-100">
        ...
        @if (!$selectedKelompokId)
            ...
            <div wire:key="view-kelas">
                ...
                <p class="text-gray-600 mb-6">Pilih kelompok untuk melihat laporan</p>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    @forelse ($kelompokList as $kelompok)
                        <div wire:click="selectKelompok({{ $kelompok['id'] }})"
                            ...
                            <h4 class="text-lg font-bold text-gray-800 mb-1">{{ $kelompok['nama_kelompok'] }}</h4>
                            <p class="text-sm text-gray-600 mb-4">{{ $kelompok['tahun_ajaran'] }}</p>

                            <div class="flex items-center justify-between">
                                <span class="text-sm font-semibold text-gray-700">{{ $kelompok['jumlah_siswa'] }} siswa</span>
                    ...
                    @empty
                        <div class="col-span-full text-center py-12">
                            <p class="text-gray-500">Tidak ada data kelompok</p>
                        </div>
                    @endforelse
                </div>
            </div>
