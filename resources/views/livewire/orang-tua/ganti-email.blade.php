        ...
        <div class="p-6 md:p-8">
            <div class="flex items-center gap-3 mb-6">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500">Email saat ini: <span
                            class="font-medium text-gray-700">{{ Auth::user()->email }}</span></p>
                </div>
            </div>

            @if($statusPesan)
                <div
                    class="p-4 mb-6 text-sm text-green-800 bg-green-50 border border-green-200 rounded-lg flex items-start gap-3">
            ...
            <form wire:submit.prevent="requestPerubahan" class="space-y-5">
                ...
                <div class="flex items-center gap-3 pt-2">
                    <button type="submit"
                        class="inline-flex justify-center px-6 py-2.5 text-sm font-medium text-white bg-green-700 border border-transparent rounded-lg hover:bg-green-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-colors shadow-sm">
