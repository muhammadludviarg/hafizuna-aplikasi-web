            ...
            <form wire:submit.prevent="gantiPassword">
                ...
                <!-- <div class="mb-6 bg-amber-50 border border-amber-200 p-4 rounded-lg">
                    <div class="flex">
                        ...
                        <div>
                            <p class="text-sm font-semibold text-amber-900 mb-1">Penting untuk Diingat:</p>
                            <ul class="text-xs text-amber-800 space-y-1">
                                <li>• Setelah mengganti password, Anda perlu login ulang</li>
                                <li>• Pastikan Anda mengingat password baru Anda</li>
