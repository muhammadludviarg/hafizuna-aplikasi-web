    ...
    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-4 md:p-6 text-gray-900 dark:text-gray-100">
            ...
            @if (!$selectedSiswaId)
                ...
                {{-- ========================================================================
                BAGIAN 2: DETAIL SISWA (STATS, HISTORY, ETC)
                ======================================================================== --}}
            @elseif ($selectedSiswaId && !$selectedSurahId)
                <div wire:key="view-detail-siswa">
                    ...
                    <div class="mb-10">
                        <h4 class="text-xl font-bold text-gray-800 mb-5 flex items-center gap-3">
                            ...
                            <div>Riwayat Sesi <span class="block text-xs font-normal text-gray-500 mt-0.5">Total
                                    {{ count($siswaDetail['riwayat_sesi']) }} sesi terekam</span></div>
                        </h4>
                        <div class="space-y-3">
                    ...
                    <div class="mb-10">
                        <h4 class="text-xl font-bold text-gray-800 mb-5 flex items-center gap-3">
                            <div class="w-1.5 h-8 bg-blue-600 rounded-full"></div>Surah Tuntas
                        </h4>
                        <div class="w-full overflow-x-auto rounded-xl border border-gray-300 shadow-sm">
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="4" class="px-4 py-8 text-center text-gray-500 italic">Belum ada surah
                                                yang tuntas 100%.</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                ...
                {{-- ========================================================================
                BAGIAN 3: DETAIL SURAH (Sama Persis dengan Admin/Guru)
                ======================================================================== --}}
            @else
