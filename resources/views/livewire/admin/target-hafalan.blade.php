                            ...
                            <div class="flex-1">
                                ...
                                <div class="flex flex-wrap gap-2 mt-3">
                                    <span class="inline-block bg-green-100 text-green-800 text-xs px-2 py-1 rounded font-medium">
                                        {{ $target->periode->label ?? 'Periode Lama' }}
                                    </span>
                    ...
                    <form wire:submit.prevent="simpanTarget" class="space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <p class="text-xs text-gray-500 mt-2">Kelompok yang sudah memiliki target ditandai "(Target sudah dibuat)"</p>
                            </div>
                            ...
                            <div>
                                ...
                                @error('tanggal_mulai') <span class="text-xs text-red-500 block mt-1">{{ $message }}</span> @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input type="date" value="{{ $tanggal_selesai }}"
                                    ...
                                    class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-green-500 focus:border-green-500 transition-colors cursor-pointer">
                                @error('tanggal_selesai') <span class="text-xs text-red-500 block mt-1">{{ $message }}</span> @enderror
                            </div>
