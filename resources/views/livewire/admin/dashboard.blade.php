<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6 border-l-4 border-yellow-500">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <div class="text-2xl font-bold text-gray-800">{{ $rataRataNilai }}</div>
        ...
        <!-- Added new analytics section with radar, bar chart, and activity list -->
        <!-- Analytics Section -->
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div class="flex items-center justify-between p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition">
                        <div class="flex items-center space-x-4">
                            ...
                            <div class="flex-shrink-0">
                                <div class="h-10 w-10 rounded-full {{ $aktivitas['warna_avatar'] }} flex items-center justify-center text-white font-bold text-sm">
                                    {{ $aktivitas['index'] }}
                                </div>
                            </div>
                            ...
                            <div class="flex-grow">
                                ...
                                <p class="text-sm text-gray-600">{{ $aktivitas['surah'] }} • Ustadz {{ $aktivitas['guru'] }}</p>
                        ...
                        <div class="flex-shrink-0 text-right">
                            <span class="inline-flex items-center justify-center h-8 w-8 rounded-full bg-green-100 text-green-700 font-bold text-sm">
                                {{ $aktivitas['nilai'] }}
                            </span>
                        </div>
                    </div>
