<div>
    ...
    <h4 class="text-sm text-gray-500 mb-6">
        Manajemen data guru, siswa, kelas, dan orang tua
    </h4>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium space-x-2">
                            <button wire:click="edit({{ $kelas->id_kelas }})" class="text-yellow-600 hover:text-yellow-900">
                                Edit
                            </button>
                            <button wire:click="hapus({{ $kelas->id_kelas }})" onclick="return confirm('Yakin ingin menghapus kelas ini?')" class="text-red-600 hover:text-red-900">
                                Hapus
                            </button>
                        </td>
                    </tr>
            ...
            <form wire:submit.prevent="simpan">
                <div class="space-y-4">
                    <div>
                        ...
                        <input wire:model="nama_kelas" type="text" id="nama_kelas" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" placeholder="Contoh: 1 Firdaus">
                    ...
                    <div>
                        ...
                        <input wire:model="tahun_ajaran" type="text" id="tahun_ajaran" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" placeholder="Contoh: 2024/2025">
