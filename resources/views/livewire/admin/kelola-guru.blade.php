<div>
    ...
    <div class="mb-4">
        <input type="text"
            ...
            placeholder="Cari nama guru, email, atau no HP..." wire:model.live="search">
    </div>
        ...
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                @forelse($guruList as $guru)
                    <tr wire:key="guru-{{ $guru->id_guru }}" class="hover:bg-gray-50 transition-colors duration-150">
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $guru->id_guru }}</td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                <div
                                    class="h-10 w-10 rounded-full bg-blue-600 text-white flex items-center justify-center mr-3 font-semibold">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-center text-sm">
                            <div class="flex items-center justify-center space-x-3">
                                <button wire:click="edit({{ $guru->id_guru }})" class="text-blue-600 hover:text-blue-900"
                                    title="Edit">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <button wire:click="resetPassword({{ $guru->id_guru }})"
                                    wire:confirm="Yakin ingin mereset password guru ini ke 'password123'?"
