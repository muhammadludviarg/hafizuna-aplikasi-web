        ...
        <div class="p-4 md:p-6 text-gray-900 dark:text-gray-100">
            ...
            @if (!$selectedKelasId)
                <div wire:key="view-kelas">
                    ...
                    <p class="text-sm md:text-base text-gray-600 mb-6">Pilih kelas untuk melihat laporan detail</p>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                        @forelse ($kelasList as $kelas)
                            <div wire:click="selectKelas({{ $kelas['id'] }})"
                                ...
                                <p class="text-sm text-gray-500 mb-4">{{ $kelas['tahun_ajaran'] }}</p>
            ...
            @elseif (!$selectedSiswaId && !$selectedSurahId)
                <div wire:key="view-daftar-siswa">
                    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
                        ...
                        {{-- Tombol Download Simetris di HP --}}
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @forelse ($detailLaporan as $index => $siswa)
                                    <tr wire:click="selectSiswa({{ $siswa['id_siswa'] }})"
                                        ...
                                        <td class="px-4 md:px-6 py-4 text-center text-sm font-medium text-gray-600">
                                            {{ $siswa['nama_kelompok'] }}
                                        </td>
            ...
            @elseif ($selectedSiswaId && !$selectedSurahId)
                <div wire:key="view-detail-siswa">
                    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
                        ...
                        {{-- Tombol Download Simetris & Full Width di HP --}}
                        <div class="flex flex-row w-full md:w-auto gap-3 self-end mt-2 md:mt-0">
