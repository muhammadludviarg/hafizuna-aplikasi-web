                    ...
                    <tr wire:key="ortu-{{ $ortu->id_ortu }}" class="hover:bg-gray-50 transition-colors duration-150">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-center text-sm">
                            <div class="flex items-center justify-center space-x-3">
                                <button wire:click="edit({{ $ortu->id_ortu }})" class="text-blue-600 hover:text-blue-900"
                                    title="Edit">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <button wire:click="resetPassword({{ $ortu->id_ortu }})"
                                    wire:confirm="Yakin ingin mereset password orang tua ini ke 'password123'?"
                                ...
                                <button wire:click="delete({{ $ortu->id_ortu }})"
                                    wire:confirm="Yakin ingin menghapus data {{ $ortu->akun->nama_lengkap ?? 'guru ini' }}?"
