<div>
    ...
    <div class="flex justify-between items-center mb-6">
        ...
        <div class="flex gap-2">
            ...
            <a href="{{ asset('templates/template_orang_tua.csv') }}" download class="px-4 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition-colors duration-200 flex items-center space-x-2">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                @forelse($orangTuaList as $ortu)
                    <tr class="hover:bg-gray-50 transition-colors duration-150">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-center text-sm">
                            ...
                            <button onclick="confirmDeleteOrtu({{ $ortu->id_ortu }}, '{{ addslashes($ortu->akun->nama_lengkap ?? 'orang tua ini') }}')"
                                    type="button"
...
<script>
function confirmDeleteOrtu(id, nama) {
    if (confirm('Yakin ingin menghapus data ' + nama + '? Data akun juga akan terhapus.')) {
