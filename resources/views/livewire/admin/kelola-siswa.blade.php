<div>
    ...
    <div class="flex justify-between items-center mb-6">
        ...
        <div class="flex gap-2">
            <button wire:click="openModal" type="button" class="px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors duration-200 flex items-center space-x-2">
            ...
            <a href="{{ asset('templates/template_siswa.csv') }}" download class="px-4 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition-colors duration-200 flex items-center space-x-2">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors duration-150">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                <div class="h-10 w-10 rounded-full bg-green-600 text-white flex items-center justify-center mr-3 font-semibold">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-center text-sm">
                            <button wire:click="edit({{ $siswa->id_siswa }})" type="button" class="text-blue-600 hover:text-blue-900 mr-3">
                                <svg class="w-5 h-5 inline" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                                </svg>
                            </button>
                            <button onclick="confirmDeleteSiswa({{ $siswa->id_siswa }}, '{{ addslashes($siswa->nama_siswa) }}')"
                                    type="button"
                ...
                <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                    <div class="bg-white px-4 pt-5 pb-4 sm:p-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <!-- Kode Siswa -->
                            <div>
                                <label class="block text-sm font-medium text-gray-700">Kode Siswa <span class="text-red-500">*</span></label>
                                <input type="text" 
                                       wire:model.defer="kode_siswa" 
                            ...
                            <div>
                                ...
                                <select wire:model.defer="id_ortu" 
                                    ...
                                    @foreach($orangTuaList as $ortu)
                                        @if($ortu->akun)
                                            <option value="{{ $ortu->id_ortu }}">{{ $ortu->akun->nama_lengkap }} ({{ $ortu->no_hp }})</option>
                                        @endif
                                    @endforeach
                                </select>
                            </div>
