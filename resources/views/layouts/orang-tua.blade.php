...
<body class="font-sans antialiased bg-gray-50 text-gray-900">
        ...
        <aside
            ...
            <div class="flex-1 overflow-y-auto py-6 flex flex-col">
                <ul class="space-y-2 px-3 transition-opacity duration-200"
                    ...
                    <li>
                        <a href="{{ route('ortu.dashboard') }}" class="group flex items-center px-4 py-3 text-sm font-medium transition-all duration-200 rounded-r-lg rounded-bl-lg whitespace-nowrap
    ...
    : 'text-green-100 hover:bg-green-700 hover:text-white hover:pl-6' }}">
                    ...
                    <li>
                        <a href="{{ route('ortu.laporan') }}" class="group flex items-center px-4 py-3 text-sm font-medium transition-all duration-200 rounded-r-lg rounded-bl-lg whitespace-nowrap
                           {{ request()->routeIs('ortu.laporan')
    ? 'bg-green-900 text-white border-l-4 border-yellow-400 shadow-inner'
    : 'text-green-100 hover:bg-green-700 hover:text-white hover:pl-6' }}">
                            Laporan Hafalan
                        </a>
                ...
                <div class="flex items-center" @click.stop>
                    <div x-data="{ dropdownOpen: false }" class="relative">
                        ...
                        <div x-show="dropdownOpen" @click.away="dropdownOpen = false"
                            ...
                            <a href="{{ route('ortu.ganti-password') }}"
                            ...
                            @if(Auth::user()->hasRole('admin'))
                                <a href="{{ route('admin.dashboard') }}"
                                    class="block px-4 py-2 text-sm text-purple-600 font-medium hover:bg-purple-50 transition-colors border-b border-gray-100">
                                    <div class="flex items-center gap-2">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
